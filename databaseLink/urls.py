...
urlpatterns = [
    ...
    url(r'^mergeevent/', views.postMoveEvent, name='postMergeEvent'),
    url(r'^transferevent/', views.postMoveEvent, name='postTransferEvent'),
    url(r'^splitevent/', views.postMoveEvent, name='postSplitEvent'),
